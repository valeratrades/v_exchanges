...
use exchange_interactions_adapters::binance::{BinanceHttpUrl, BinanceOption};
use eyre::Result;
use jiff::Timestamp;
...
pub(super) async fn klines(client: &exchange_interactions_adapters::Client, symbol: Symbol, tf: BinanceTimeframe, range: RequestRange) -> Result<Klines, ExchangeError> {
...
// open_interest {{{
pub(super) async fn open_interest(client: &exchange_interactions_adapters::Client, symbol: Symbol, tf: BinanceTimeframe, range: RequestRange) -> Result<Vec<OpenInterest>, ExchangeError> {
...
pub(crate) async fn fetch_book_snapshot(client: &exchange_interactions_adapters::Client, pair: Pair, instrument: Instrument, prec: PrecisionPriceQty) -> Result<BookShape, ExchangeError> {
