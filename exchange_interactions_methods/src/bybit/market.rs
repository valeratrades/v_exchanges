...
use ahash::AHashMap;
use exchange_interactions_adapters::bybit::BybitOption;
use jiff::Timestamp;
...
pub(super) async fn klines(client: &exchange_interactions_adapters::Client, symbol: Symbol, tf: BybitInterval, range: RequestRange) -> ExchangeResult<Klines> {
...
pub(super) async fn prices(client: &exchange_interactions_adapters::Client, pairs: Option<Vec<Pair>>, instrument: Instrument) -> ExchangeResult<BTreeMap<Pair, f64>> {
...
pub(super) async fn open_interest(client: &exchange_interactions_adapters::Client, symbol: Symbol, tf: BybitIntervalTime, range: RequestRange) -> ExchangeResult<Vec<OpenInterest>> {
...
pub(super) async fn exchange_info(client: &exchange_interactions_adapters::Client, instrument: Instrument) -> ExchangeResult<ExchangeInfo> {
