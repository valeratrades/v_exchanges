...
#[diagnostic(code(exchange_interactions::unsupported_timeframe), help("Use one of the allowed timeframes for this exchange."))]
...
pub enum MethodError {
	...
	#[diagnostic(
		code(exchange_interactions::method::not_implemented),
	...
	#[diagnostic(
		code(exchange_interactions::method::not_supported),
		help("This exchange does not support this method for the specified instrument type.")
	)]
	MethodNotSupported {
		exchange: ExchangeName,
		instrument: Instrument,
	...
	#[diagnostic(code(exchange_interactions::method::pair_not_listed))]
	PairNotListed {
		exchange: ExchangeName,
		instrument: Instrument,
		pair: Pair,
...
#[diagnostic(code(exchange_interactions::range::out_of_range), help("Adjust the request parameters to fall within the allowed range."))]
